      ...
      <div className="mx-auto max-w-5xl">
        ...
        <fieldset disabled={!canManageOrganization} className="grid gap-6 lg:grid-cols-[1fr_320px]">
          <div className="space-y-6">
            ...
            <section className="rounded-2xl border bg-card p-6 shadow-xs">
              <h2 className="font-semibold">Company Story</h2>
              <p className="mb-5 text-sm text-muted-foreground">A longer narrative shown below the hero, plus a contact email candidates can write to.</p>
              <div className="grid gap-4">
            ...
            <section className="rounded-2xl border bg-card p-6 shadow-xs">
              <div className="flex items-start justify-between"><div><h2 className="font-semibold">Team Members</h2><p className="text-sm text-muted-foreground">Introduce the people candidates would work with.</p></div><Button size="sm" variant="outline" onClick={() => patch({ teamMembers: [...(settings.teamMembers ?? []), { name: "", role: "" }] })}><PlusIcon /> Add</Button></div>
